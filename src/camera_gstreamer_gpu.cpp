...
int main() {
    // Define the GStreamer pipeline for the camera with GPU support
    std::string pipeline = "libcamerasrc ! video/x-raw,format=NV12,width=1280,height=720 ! v4l2convert ! video/x-raw,format=NV12 ! glimagesink";
